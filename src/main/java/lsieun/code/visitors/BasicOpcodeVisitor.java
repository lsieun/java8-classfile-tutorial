...
public class BasicOpcodeVisitor implements OpcodeVisitor {
    ...
    private static final String CP_INS_FORMAT = "%04d: %-15s #%-3s // %s%n";
    private static final String NEW_ARRAY_FORMAT = "%04d: %-15s %-4s // %s%n";

    private final byte[] code_bytes;

    public BasicOpcodeVisitor(byte[] code_bytes) {
    ...
    public void visitANEWARRAY(final ANEWARRAY obj) {
        ...
        System.out.printf(CP_INS_FORMAT, obj.pos, name, cpIndex, hexCode);
    }
    ...
    public void visitIINC(final IINC obj) {
        ...
        String hexCode = getHexCode(obj);
        System.out.printf(TWO_ARG_FORMAT, obj.pos, name, localVarIndex, increment, hexCode);
    }
    ...
    public void visitNEWARRAY(final NEWARRAY obj) {
        ...
        System.out.printf(NEW_ARRAY_FORMAT, obj.pos, name, atype);
    }
